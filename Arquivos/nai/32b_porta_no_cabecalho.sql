-- =====================================================================
-- NAI -- 32b: a porta entra no cabecalho do turno.
--
-- Gerado por `scratchpad/patch_porta.py` a partir do que estava NO BANCO.
-- Tres acrescimos, nenhuma remocao: a chamada a `nai_deve_atender` e os
-- campos `atende` e `porta` no cabecalho.
--
-- Com `regra_publico = nao`, `atende` vem NULL e o roteador decide como
-- sempre decidiu. Nada muda ate a chave ser ligada.
--
-- Rode `32_ligar_a_porta.sql` ANTES deste arquivo.
-- =====================================================================
