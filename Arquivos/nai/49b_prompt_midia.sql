-- =====================================================================
-- NAI -- 49b: a regra da midia tambem no prompt (Tel, 16/09/2026)
--
-- O arquivo 49 avisa no cabecalho, mensagem a mensagem. Esta e a regra fixa,
-- que vale mesmo se o aviso faltar: a frase "nao consigo abrir" nunca vai
-- para o corretor, em forma nenhuma.
-- =====================================================================
...
- Nesse caso, chame escalar_ao_tel e responda exatamente SILENCIO. O Tel abre a mídia e segue com ele.
