-- =====================================================================
-- NAI -- 34b: o turno guarda a decisao da porta.
--
-- Gerado por script a partir do que estava NO BANCO: o INSERT do turno passa
-- a gravar `porta`. Um acrescimo, nenhuma remocao.
--
-- E o que faz o painel poder LER a decisao em vez de recalcular -- e
-- recalcular seria escrever, porque `nai_deve_atender` libera conversa.
--
-- Rode `34_porta_gravada_no_turno.sql` ANTES deste arquivo.
-- =====================================================================
