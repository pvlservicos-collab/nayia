-- =====================================================================
-- NAI -- 44: o convite de visita volta a sair quando a foto vai junto.
--
-- Gerado por script a partir do que estava NO BANCO. Um acrescimo.
-- Rode `43_fotos_sempre_junto.sql` e o `43b` ANTES.
-- =====================================================================
