-- =====================================================================
-- NAI -- 46: a voz cordial da Nay (Tel, 16/09/2026)
--
-- Ele: "ela respondeu de forma muito rispida, nem deu o bom dia dele -- ela so
-- perguntou 'de qual imovel voce fala?', sendo que ele ja tinha dito que era
-- casa do Aleixo. Trabalha melhor a educacao dela, ja que ela e uma mulher:
-- tem que responder a educacao do cliente. Quero cordialidade, educacao e
-- delicadeza sem forcar, e cumprimentos curtos."
-- E antes: "ela ainda deveria ter cumprimentado -- 'Oi Martinha, e claro, vou
-- te enviar!'".
--
-- O QUE ACONTECIA: as 04:00 o corretor Carlus escreveu "Essa casa no Aleixo
-- ainda esta disponivel mana? / Bom diaaaaaaaa" e ela respondeu "de qual imovel
-- voce fala? me manda o codigo" -- sem bom dia, em letra minuscula, com "voce".
--
-- A secao "COMO VOCE FALA" tinha tres linhas de cordialidade. Agora ela e um
-- catalogo por momento, com o par "o que sai seco -> o que uma brasileira
-- diria" em cada um, porque proibicao curta sem exemplo nao segura o modelo.
-- Os momentos: devolver o cumprimento, aceitar o pedido com gosto, pedir
-- esclarecimento sem secura, agradecer, fechar, e a lista das palavras dela.
--
-- Vai junto a linha do acompanhante, que ainda dizia "Fernando" -- quem diz
-- agora e o cadastro (arquivo 41).
--
-- As frases fixas que moram DENTRO das funcoes nao passam por aqui: o prompt
-- manda repetir texto_pronto exatamente. Elas sao o arquivo 47.
-- =====================================================================
