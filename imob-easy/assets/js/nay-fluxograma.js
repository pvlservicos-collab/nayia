...
(function () {
  ...
  // ------------------------------------------------------------------
  // ------------------------------------------------------------------
  // O QUE CADA COISA E, exatamente. A barra de cima explica; o cartao
  // carrega a etiqueta. Sem isto, "Liberar saida" e "Qual caminho?"
  // parecem a mesma especie de coisa, e nao sao.
  // ------------------------------------------------------------------
  var NATUREZA = {
    no:     { curto: "nó n8n",   nome: "um nó do n8n",
              ajuda: "uma caixa sozinha no canvas do n8n" },
    nos:    { curto: "conjunto", nome: "um conjunto de nós",
              ajuda: "vários nós do n8n trabalhando como uma coisa só" },
    regra:  { curto: "regra BD", nome: "uma regra do banco",
              ajuda: "uma função PostgreSQL — muda com SQL, sem mexer no n8n" },
    prompt: { curto: "prompt",   nome: "um prompt",
              ajuda: "texto que instrui o modelo — editável no painel, sem deploy" }
  };
  var CLASSE = {
    check: { curto: "check", nome: "confere", ajuda: "olha e pode BARRAR o que vem depois" },
    acao:  { curto: "ação",  nome: "faz",     ajuda: "executa alguma coisa e segue" }
  };
  ...
  var GRUPOS = [
    { setor: "entrada", titulo: "1. Entrada", etapas: [
      { n: "Chega a mensagem", principal: true, classe: "acao", natureza: "no", tipo: "n8n", onde: "n8n · nó Webhook (v2.1)",
      ...
      { n: "Filtrar e normalizar", principal: false, classe: "check", natureza: "no", tipo: "n8n", onde: "n8n · nó Filtrar e normalizar (code, 122 linhas)",
      ...
      { n: "Foi o Tel pelo celular?", principal: false, classe: "check", natureza: "nos", tipo: "parede", onde: "n8n · Foi o Tel pelo celular? → Espera 15s → nai_tel_assumiu()",
      ...
      { n: "Gravar na fila", principal: false, classe: "acao", natureza: "no", tipo: "sql", onde: "n8n · Gravar na fila → tabela mensagens",
        oque: "Grava a mensagem com status Recebido. É a fila de onde tudo sai." },
      { n: "Janela de espera", principal: false, classe: "acao", natureza: "no", tipo: "n8n", onde: "n8n · Janela de 25s · nai_config.janela_segundos = 60",
      ...
      { n: "Reservar mensagens", principal: true, classe: "acao", natureza: "no", tipo: "sql", onde: "n8n · Reservar mensagens",
    ...
    { setor: "entrada", titulo: "2. Mídia vira texto", etapas: [
      { n: "Detectar áudio", principal: false, classe: "check", natureza: "no", tipo: "n8n", onde: "n8n · Detectar audio (code, 12 linhas)",
        oque: "Vê se veio áudio no lote." },
      { n: "Baixar e transcrever", principal: false, classe: "acao", natureza: "nos", tipo: "modelo", onde: "n8n · Baixar audio → Transcrever (OpenAI whisper, pt)",
      ...
      { n: "Detectar imagem", principal: false, classe: "check", natureza: "no", tipo: "n8n", onde: "n8n · Detectar imagem (code, 59 linhas)",
        oque: "Vê se veio foto ou documento no lote." },
      { n: "Ler a imagem", principal: false, classe: "acao", natureza: "no", tipo: "modelo", onde: "n8n · Ler imagem (GPT) (httpRequest)",
      ...
      { n: "Juntar mensagens", principal: true, classe: "acao", natureza: "no", tipo: "n8n", onde: "n8n · Juntar mensagens (code, 186 linhas)",
    ...
    { setor: "identidade", titulo: "3. Quem é a pessoa", etapas: [
      { n: "A chave", principal: false, classe: "acao", natureza: "regra", tipo: "sql", onde: "nai_chave() → nay_fone_chave()",
      ...
      { n: "Resolver o @lid", principal: false, classe: "acao", natureza: "regra", tipo: "sql", onde: "tabela identidade_lid · nai_contato_irmaos()",
    ...
    { setor: "porta", titulo: "4. A porta", etapas: [
      { n: "Quem atende?", principal: false, classe: "check", natureza: "regra", tipo: "parede", onde: "nai_quem_atende(fone, grupo, texto)",
      ...
      { n: "Deve atender?", principal: true, classe: "check", natureza: "regra", tipo: "parede", onde: "nai_deve_atender() → grava o motivo em nai_turno.porta",
      ...
      { n: "Está na lista?", principal: false, classe: "check", natureza: "regra", tipo: "parede", onde: "nai_pode_falar() · corretores.pode_falar · nai_lista_governa()",
      ...
      { n: "O Tel está na conversa?", principal: false, classe: "check", natureza: "regra", tipo: "parede", onde: "nai_tel_com_a_conversa() · nai_config.gap_tel_min = 30",
    ...
    { setor: "cabecalho", titulo: "5. O cabeçalho", etapas: [
      { n: "Abrir turno", principal: true, classe: "acao", natureza: "regra", tipo: "sql", onde: "nai_abrir_turno() → tabela nai_turno",
      ...
      { n: "Montar o prompt", principal: true, classe: "acao", natureza: "prompt", tipo: "modelo", onde: "tabela nai_prompt (corretor 9.502b · proprietário 2.239b · Fernando 813b)",
      ...
      { n: "Rotear pelo cabeçalho", principal: false, classe: "acao", natureza: "no", tipo: "n8n", onde: "n8n · Rotear pelo cabeçalho (code, 100 linhas)",
        oque: "Lê o que o Abrir turno devolveu e escolhe por qual das 8 saídas seguir." },
      { n: "Qual caminho?", principal: true, classe: "check", natureza: "no", tipo: "n8n", onde: "n8n · Qual caminho? (switch, 8 saídas)",
    ...
    { setor: "modelo", titulo: "6. O modelo pensa", etapas: [
      { n: "O agente", principal: true, classe: "acao", natureza: "nos", tipo: "modelo", onde: "n8n · NAI (corretor) / (proprietário) / (Fernando) — agent v3.1",
        oque: "Três agentes, um por papel. Cada um com seu prompt, sua memória e suas ferramentas." },
      { n: "O modelo", principal: false, classe: "acao", natureza: "no", tipo: "modelo", onde: "n8n · GPT (corretor) — lmChatOpenAi · modelo gpt-5.6-sol",
      ...
      { n: "A memória", principal: false, classe: "acao", natureza: "no", tipo: "sql", onde: "n8n · Memória (corretor) — memoryPostgresChat · tabela nai_memoria",
    ...
    { setor: "ferramenta", titulo: "7. As ferramentas (17)", etapas: [
      { n: "Achar imóvel", principal: false, classe: "acao", natureza: "nos", tipo: "sql", onde: "imovel_por_codigo · buscar_por_perfil · listar_no_condominio · disponibilidade_no_condominio · resumo_do_condominio",
      ...
      { n: "Saber do imóvel", principal: false, classe: "acao", natureza: "nos", tipo: "sql", onde: "o_que_sei_do_imovel · guardar_do_imovel · imovel_do_disparo",
        oque: "Responde pergunta sobre um imóvel (mobília, andar, vaga, IPTU, financiamento) e guarda o que o Tel ensinar na conversa." },
      { n: "A visita", principal: false, classe: "acao", natureza: "nos", tipo: "sql", onde: "pedir_visita · guardar_dados_da_visita · mudar_horario_da_visita · responder_horario_do_proprietario · resultado_da_visita",
        oque: "Todo o ciclo: pedir a visita, coletar nome, CPF e CRECI, remarcar horário e registrar como foi." },
      { n: "Escalar ao Tel", principal: false, classe: "check", natureza: "regra", tipo: "parede", onde: "escalar_ao_tel → nai_escalar()",
      ...
      { n: "A descrição é prompt", principal: false, classe: "check", natureza: "prompt", tipo: "parede", onde: "n8n · toolDescription de cada ferramenta",
    ...
    { setor: "conferencia", titulo: "8. A esteira", etapas: [
      { n: "Achar código na resposta", principal: false, classe: "acao", natureza: "no", tipo: "n8n", onde: "n8n · Achar codigo na resposta (code, 43 linhas)",
        oque: "Procura 'Código: NNNN' no que o modelo escreveu, para saber de qual imóvel mandar foto." },
      { n: "Fotos faltando?", principal: false, classe: "check", natureza: "nos", tipo: "sql", onde: "n8n · Fotos faltando? → nai_fotos_faltando() → Buscar fotos no site",
        oque: "Se o imóvel não tem foto no banco, busca no anúncio do site na hora." },
      { n: "As 17 conferências", principal: true, classe: "check", natureza: "regra", tipo: "parede", onde: "nai_enfileirar_resposta() → nai_conferir_resposta() → tabela nai_conferencia",
    ...
    { setor: "montagem", titulo: "9. Montagem", etapas: [
      { n: "Card e fotos", principal: true, classe: "acao", natureza: "regra", tipo: "sql", onde: "nai_enfileirar_card() · nai_imagens_do_envio()",
      ...
      { n: "Depois das fotos", principal: false, classe: "acao", natureza: "regra", tipo: "sql", onde: "nai_depois_das_fotos()",
        oque: "As frases que fecham o bloco: a sugestão de visita e o convite a pedir mais imóveis." },
      { n: "Quebrar em balões", principal: false, classe: "acao", natureza: "regra", tipo: "sql", onde: "nai_enfileirar_texto() → tabela nai_saida",
    ...
    { setor: "saida", titulo: "10. A caixa de saída", etapas: [
      { n: "O gatilho da inserção", principal: false, classe: "check", natureza: "regra", tipo: "parede", onde: "gatilho nai_saida_validar na tabela nai_saida",
      ...
      { n: "Liberar saída", principal: true, classe: "check", natureza: "regra", tipo: "parede", onde: "nai_liberar_saida()",
      ...
      { n: "Proprietário vai pro Tel", principal: false, classe: "check", natureza: "regra", tipo: "parede", onde: "nai_config.proprietario_pelo_tel = sim",
      ...
      { n: "Conferir cabeçalho", principal: false, classe: "check", natureza: "no", tipo: "n8n", onde: "n8n · Conferir cabeçalho (code, 28 linhas)",
      ...
      { n: "Enviar", principal: true, classe: "acao", natureza: "nos", tipo: "saida", onde: "n8n · Pode enviar? → Enviar Z-API → Confirmar envio",
    ...
    { setor: "agenda", titulo: "11. A agenda (roda sozinha)", etapas: [
      { n: "Todo minuto", principal: true, classe: "acao", natureza: "no", tipo: "n8n", onde: "n8n · Agenda (todo minuto) — scheduleTrigger",
        oque: "Um gatilho por minuto, independente de alguém escrever alguma coisa." },
      { n: "O que está devendo", principal: false, classe: "acao", natureza: "regra", tipo: "sql", onde: "n8n · Agenda da NAI → nai_agenda_tick()",
        oque: "Lembrete de visita, cobrança dos dados que faltam, aviso ao Fernando, aviso ao Tel, pós-visita e devolver a chave." },
      { n: "Volta pela saída", principal: false, classe: "acao", natureza: "regra", tipo: "sql", onde: "→ Liberar saída (a mesma do passo 10)",
    ...
    { setor: "comandos", titulo: "12. Comandos do Tel", etapas: [
      { n: "Comando do Tel", principal: true, classe: "acao", natureza: "nos", tipo: "sql", onde: "n8n · Comando do Tel (code, 113 linhas) → nai_comando_tel()",
  ...
  function cartao(gi, ei, e, passo) {
    var nt = NATUREZA[e.natureza] || NATUREZA.no;
    var cl = CLASSE[e.classe] || CLASSE.acao;
    return '<button class="fx__etapa fx__etapa--' + e.tipo +
      (e.principal ? " fx__etapa--principal" : "") + '" type="button"' +
      ' aria-pressed="false" data-fx="' + gi + "." + ei + '"' +
      ' title="Passo ' + passo + ": " + esc(e.n) + " — " + esc(cl.nome) + ", " + esc(nt.nome) + '">' +
      '<div class="fx__cab"><span class="fx__num">' + passo + "</span>" +
      '<span class="fx__nome">' + esc(e.n) + "</span></div>" +
      '<div class="fx__tags">' +
        '<span class="fx__tag fx__tag--' + e.classe + '">' + esc(cl.curto) + "</span>" +
        '<span class="fx__tag fx__tag--' + e.natureza + '">' + esc(nt.curto) + "</span>" +
      "</div>" +
  ...
  function desenhar() {
    ...
    // TRES FAIXAS por setor: acima, a corda (as principais), e abaixo.
    // O que e principal fica NA corda; o resto sobe ou desce, alternando,
    // para o tronco do caminho ficar legivel de longe.
    ...
    FASES.forEach(function (f) {
      ...
      f.grupos.forEach(function (gi) {
        ...
        g.etapas.forEach(function (e, ei) {
          passo++;
          var c = cartao(gi, ei, e, passo);
          if (e.principal) {
            meio += '<div class="fx__cel">' + c + "</div>";
            cima += '<div class="fx__cel"></div>';
            baixo += '<div class="fx__cel"></div>';
          } else if (vez++ % 2 === 0) {
            cima += '<div class="fx__cel">' + c + '<span class="fx__gancho fx__gancho--desce"></span></div>';
            meio += '<div class="fx__cel fx__cel--no"></div>';
            baixo += '<div class="fx__cel"></div>';
          } else {
            baixo += '<div class="fx__cel"><span class="fx__gancho fx__gancho--sobe"></span>' + c + "</div>";
            meio += '<div class="fx__cel fx__cel--no"></div>';
            cima += '<div class="fx__cel"></div>';
          }
        });
        ...
        html += '<div class="fx__grupo-topo"><span class="fx__farol fx__farol--' +
                ...
                "</div>";
        html += '<div class="fx__faixa fx__faixa--cima">' + cima + "</div>";
        html += '<div class="fx__faixa fx__faixa--meio">' + meio + "</div>";
        html += '<div class="fx__faixa fx__faixa--baixo">' + baixo + "</div>";
        html += "</div>";
      });
    ...
    if (total) {
      var pr = PLANO.filter(function (x) { return x.e.principal; }).length;
      total.textContent = PLANO.length + " etapas em " + FASES.length + " fases · " +
        pr + " no tronco, " + (PLANO.length - pr) + " ao redor";
    }
  }
  ...
  function abrir(ref, semRolar) {
    ...
    var nt = NATUREZA[e.natureza] || NATUREZA.no;
    var cl = CLASSE[e.classe] || CLASSE.acao;
    h += '<p class="fx__oque-e"><span class="fx__tag fx__tag--' + e.classe + '">' +
         esc(cl.curto) + "</span> " + esc(cl.ajuda) + ' &nbsp;·&nbsp; ' +
         '<span class="fx__tag fx__tag--' + e.natureza + '">' + esc(nt.curto) + "</span> " +
         esc(nt.nome) + " — " + esc(nt.ajuda) +
         (e.principal ? ' &nbsp;·&nbsp; <strong>etapa do tronco</strong>' : "") + "</p>";
